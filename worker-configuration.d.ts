/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7ae0d2ae99b8abd1f0939db6a6d47e1d)
// Runtime types generated with workerd@1.20260114.0 2025-07-30 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		Globe: DurableObjectNamespace<import("./src/worker-entry").Globe>;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "AI_GATEWAY_URL" | "AI_GATEWAY_TOKEN">> {}
}
